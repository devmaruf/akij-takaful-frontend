...
import { changeInputValue, getEmployeeDetails } from '@/redux/actions/employee-action';
...
export default function Edit() {
  ...
  const { employeeInput, isSubmitting, isLoadingDetails } = useSelector((state: RootState) => state.employee);
