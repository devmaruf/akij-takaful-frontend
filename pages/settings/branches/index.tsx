...
import { changeInputValue, submitBranch, getBranchList, getBranchDetails, deleteBranch, updateBranch } from '@/redux/actions/BranchAction';
...
export default function Proposals() {
    ...
    return (
        <div>
            ...
            {/** Add Project Modal */}
            <Modal title={`Add Branch`} size="md" show={showModal} handleClose={() => setShowModal(false)} isDismissible={false}>
                <form
                    method="post"
                    autoComplete="off"
                ...
                >
                    ...
                    <Select
                        options={projectOptionList}
                        isSearchable={true}
                        name="service_cell_id"
                        label="Service Cell"
                        defaultValue=""
                        placeholder='Select Service Cell...'
                        handleChangeValue={changeTextInput}
                    />
                    <div className="mt-2">
                        <Button
                        ...
                        <div className="text-gray-900">
                            {
                                (typeof branchDetails !== "undefined" && branchDetails !== null) ? (
                                    <div className="grid gap-2 grid-cols-2">
                                        ...
                                        <h6>{branchDetails.service_cell_id}</h6>
                                        <div className='flex justify-between'>
                                            <h6>Status</h6>
                                            <h6>:</h6>
                                        </div>
